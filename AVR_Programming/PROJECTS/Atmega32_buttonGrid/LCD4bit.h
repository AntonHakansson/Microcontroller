...
#define lcd_D4_bit				PINB0
#define lcd_D5_bit				PINB1
#define lcd_D6_bit				PINB2
#define lcd_D7_bit				PINB3

#define lcd_RS_bit 				PINB4
#define lcd_RW_bit				PINB5
#define lcd_E_bit 				PINB6
